...
import 'package:quiz_app/service/get_qeustion.dart';
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              List<QuestionModel> questions = List.generate(
                  temp['questions'].length, (index) => QuestionModel.fromMap(temp[''][index]));
              selectedAnswerIndices = List<int>.filled(questions.length, -1);
                      ...
                      Stack(
                        children: [
                          Container(
                            ...
                            child: Padding(
                              padding:
                                  const EdgeInsets.only(bottom: 150, left: 10),
                              child: Row(
                                children: [
                                  IconButton(
                                      onPressed: () {
                            ...
                            itemBuilder: (context, ind) => InkWell(
                              onTap: () {
                                ...
                                setState(() {
                                  ...
                                  selectedAnswerIndices[index] = ind;
                                });
                                checkAnswer(
                                    isCorrect:
                                        questions[index].answers[ind].isCorrect,
